...
public class Empregado extends Pessoa {
	...
	public Empregado(String nome, Genero genero, LocalDate dataNascimento, String cpf, Empresa empresa, String pis, String ctps, Endereco endereco, Contato contato, Escolaridade escolaridade, String nomeMae, SimpleDateFormat cargaHoraria, LocalDate dataAdmissao, LocalDate terminoContratoExperiencia, TipoContrato tipoContrato, Funcao funcao, float salario) {
		super(nome, genero, dataNascimento, cpf);
	...
	public boolean equals(Object objeto) {
		...
		return this.getPessoa().equals(empregado.getPessoa()) && this.getEmpresa().equals(empregado.getEmpresa()) && this.getPis().equals(empregado.getPis()) && this.getCtps().equals(empregado.getCtps()) && this.getEndereco().equals(empregado.getEndereco()) && this.getContato().equals(empregado.getContato()) && this.getEscolaridade().equals(empregado.getEscolaridade()) && this.getNomeMae().equals(empregado.getNomeMae()) && this.getCargaHoraria().equals(empregado.getCargaHoraria()) && this.getDataAdmissao().equals(empregado.getDataAdmissao()) && this.getTerminoContratoExperiencia().equals(empregado.getTerminoContratoExperiencia()) && this.getTipoContrato().equals(empregado.getTipoContrato()) && this.getFuncao().equals(empregado.getFuncao()) && this.getSalario().equals(empregado.getSalario());
	}
}